...
Organize scratchpad work into **dated subfolders** named `YYYY-MM-DD-short-description/` (e.g., `2026-04-09-editor-model-retainers/`). Each subfolder should contain:
...
```bash
cd .github/skills/heap-snapshot-analysis
node --max-old-space-size=16384 scratchpad/2026-04-09-editor-model-retainers/analyze.mjs
```
