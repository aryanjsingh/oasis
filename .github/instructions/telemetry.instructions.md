...
**Naming Conventions:**
- Event names: `camelCase` with context (`extensionActivationError`, `commandExecuted`)
- Property names: specific and descriptive (`extensionId` not `id`, `durationMs` not `duration`)
