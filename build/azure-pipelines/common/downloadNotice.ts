...
//
// It uses a detached background-download harness: a detached
...
// A never-produced artifact degrades to fallback quickly, but with generous
// margin over the parallel Quality stage (CG + scan + merge).
