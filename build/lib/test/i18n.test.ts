...
suite('XLF Parser Tests', () => {
	...
	test('JSON file source path to Transifex resource match', () => {
		...
		const platform: i18n.Resource = { name: 'vs/platform', project: editorProject },
			...
			sessionsContrib = { name: 'vs/sessions/contrib/output', project: sessionsProject },
		...
		assert.deepStrictEqual(i18n.getResource('vs/sessions/contrib/output/browser/outputWidget'), sessionsContrib);
