...
export interface IPolicy {
	...
	*/
	...
	/**
	 * Declares managed-settings keys this policy's value callback reads.
 ...
 * letting a single enterprise policy lock more than one setting (e.g. gating a feature in both the
