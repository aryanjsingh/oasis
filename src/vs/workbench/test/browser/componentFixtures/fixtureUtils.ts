...
// Import auxiliaryBarPart.css here so fixture components get product layout styles.
// Fixtures that wrap content in `.part.auxiliarybar`
...
export function registerWorkbenchServices(registration: ServiceRegistration): void {
	...
	// Reports the workspace as trusted so fixture components render normally.
