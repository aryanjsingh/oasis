...
suite('Telemetry - common properties', function () {
	...
	test('default', function () {
		const props = resolveWorkbenchCommonProperties(testStorageService, undefined!, testEnvironmentService, release(), hostname(), 'someMachineId', 'someSqmId', 'somedevDeviceId', false, process);
