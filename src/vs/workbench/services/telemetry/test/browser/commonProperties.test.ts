...
suite('Browser Telemetry - common properties', function () {
	...
	const testEnvironmentService = { remoteAuthority: undefined } as IWorkbenchEnvironmentService;
	...
	test('mixes in additional properties', async function () {
		...
		const props = resolveWorkbenchCommonProperties(testStorageService, undefined!, testEnvironmentService, false, resolveCommonTelemetryProperties);
	...
	test('mixes in additional dyanmic properties', async function () {
		...
		const props2 = resolveWorkbenchCommonProperties(testStorageService, undefined!, testEnvironmentService, false, resolveCommonTelemetryProperties);
