...
export class NativeIssueFormService extends IssueFormService implements IIssueFormService {
	...
	override async openReporter(data: IssueReporterData): Promise<void> {
		...
		// When editors open in a floating modal editor part by default, the issue
		// reporter needs to sit alongside the rest of the app so the user can
		// capture screenshots and recordings. Target the main editor part's active
		// group explicitly to open it docked in the editor area instead of as a
		// modal overlay.
