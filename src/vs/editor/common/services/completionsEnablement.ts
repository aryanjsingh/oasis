 ...
 */
export function isCompletionsEnabled(_configurationService: IConfigurationService, _modeId: string = '*'): boolean {
	return false;
}
 ...
 * @returns `true` if completions are enabled for the language, `false` otherwise.
 */
export function isCompletionsEnabledWithTextResourceConfig(_configurationService: ITextResourceConfigurationService, _resource: URI, _modeId: string = '*'): boolean {
	return false;
}
