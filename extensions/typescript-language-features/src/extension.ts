...
import { createExperimentationTelemetryReporter, IExperimentationTelemetryReporter } from './experimentTelemetryReporter';
...
export function activate(
	...
	if (packageInfo) {
		...
		experimentTelemetryReporter = createExperimentationTelemetryReporter();
