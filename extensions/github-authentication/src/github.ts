...
import { ExperimentationTelemetry, createTelemetryReporter } from './common/experimentationService';
...
export class GitHubAuthenticationProvider implements vscode.AuthenticationProvider, vscode.Disposable {
	...
	constructor(
		...
		this._telemetryReporter = new ExperimentationTelemetry(context, createTelemetryReporter());
